/* CS261 - Assignment 2 Part 1 dynamicArray.c
 * Name:	Brendan Jang
 * Date:	4/21/2019
 * Solution Description: Program that completes dyanmic array and
 * 						 dynamic array-based implementation of a stack and
 * 						 a bag.
 */ 						 
...
void swapDynArr(DynArr *v, int i, int  j)
{
	...
	/* Use temp variable to swap elements*/
	int swap = v->data[i];
	v->data[i] = v->data[j];
	v->data[j] = swap;
}
